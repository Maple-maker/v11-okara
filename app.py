...
def generate():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if item_count == 0:
                flash('No items found in BOM PDF. Please check your file or try a different start page.', 'error')
                return redirect(url_for('index'))
        ...
        flash(f'Invalid start page value. Please enter a number.', 'error')
        return redirect(url_for('index'))
